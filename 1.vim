...
badd +0 src/View/Modals/dataTransferModal.tsx
argglobal
%argdel
edit src/View/Modals/dataTransferModal.tsx
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 126) / 253)
exe 'vert 2resize ' . ((&columns * 221 + 126) / 253)
argglobal
enew
