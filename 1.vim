...
badd +132 src/Model/Global/fileTransferModel.ts
badd +0 src/Model/Utility/utility.ts
badd +1 src/View/Modals/dataTransferModal.tsx
badd +669 src/View/translations.ts
...
exe 'vert 2resize ' . ((&columns * 111 + 73) / 146)
exe 'vert 3resize ' . ((&columns * 2 + 73) / 146)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 130 - ((13 * winheight(0) + 11) / 22)
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 73) / 146)
exe 'vert 2resize ' . ((&columns * 57 + 73) / 146)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 117 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 117
