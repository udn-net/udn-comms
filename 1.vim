...
badd +1 src/Model/Global/fileTransferModel.ts
...
badd +0 src/ViewModel/Global/fileTransferViewModel.ts
argglobal
%argdel
set stal=2
...
exe 'vert 2resize ' . ((&columns * 196 + 127) / 255)
exe 'vert 3resize ' . ((&columns * 3 + 127) / 255)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 130 - ((0 * winheight(0) + 23) / 47)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 233 - ((0 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 233
...
silent! normal! zE
let &fdl = &fdl
let s:l = 123 - ((20 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 123
...
silent! normal! zE
let &fdl = &fdl
let s:l = 163 - ((34 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 163
