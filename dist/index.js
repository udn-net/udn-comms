(() => {
 ...
 Usage: "children:append={[list, converter]}"; you can find a more detailed example in the documentation.`;
    ...
    var allTranslations = {
        ...
        de: {
            ...
            dataTransferModal: {
                ...
                selectionDescription:
                    "W\xE4hle die Daten aus, die du \xFCbertragen m\xF6chtest.",
                dataEntryDescription:
                    "Gib diese Informationen auf dem anderen Ger\xE4t ein.",
                dataEntryInputDescription:
                    "Gib die auf dem anderen Ger\xE4t angezeigten Informationen ein.",
            ...
            chatPage: {
                ...
                settings: {
                    ...
                    newSecondaryChannelPlaceholder:
                        "Sekund\xE4ren Kanal hinzuf\xFCgen",
                    newSecondaryChannelAudioLabel:
                        "Name des neuen sekund\xE4ren Kanals",
                ...
                message: {
                    ...
                    doubleAttentionReaction:
                        "Reaktion: doppeltes Ausrufezeichen",
        ...
        es: {
            ...
            dataTransferModal: {
                ...
                notConnectedError:
                    "No est\xE1s conectado a ning\xFAn servidor.",
                ...
                transferKeyHeadline:
                    "Clave de Encriptaci\xF3n de Transferencia",
                sendButton: "Enviar",
            ...
            chatPage: {
                ...
                settings: {
                    ...
                    setEncryptionKeyButtonAudioLabel:
                        "establecer clave de encriptaci\xF3n",
                ...
                message: {
                    ...
                    showMessageInfoButtonAudioLabel:
                        "mostrar informaci\xF3n del mensaje",
                    ...
                    doubleAttentionReaction:
                        "Reaccion: signo de atenci\xF3n doble",
    ...
    function checkDoesObjectMatchReference(
        reference,
        stringEntryObject,
        explicitEmptyValue = false,
    ) {
        reference_entry_loop: for (const referenceEntry of Object.entries(
            ...
            if (referenceValue[0] == "-") {
                const strippedReferenceValue = referenceValue
                    .toString()
                    .substring(1);
                if (
                    strippedReferenceValue == "" &&
                    stringEntryObjectValue != void 0 &&
    ...
    var CoreViewModel = class _CoreViewModel {
        ...
        constructor(
            ...
            this.handleChron = () => {
                ...
                if (
                    this.unwrappedTodayDate.toDateString() ==
            ...
            this.translations =
                allTranslations[settingsModel2.language] || allTranslations.en;
        ...
        constructor() {
            ...
            this.recurse = (rootDirectory, fn) => {
                loop_over_files: for (const key of Object.keys(localStorage)) {
                    const pathComponentsOfCurrentEntity =
                        _StorageModel.stringToPathComponents(key);
                    loop_over_path_components: for (
                        let i = 0;
                        i < rootDirectory.length;
                        i++
                    ) {
                        if (!pathComponentsOfCurrentEntity[i])
                            continue loop_over_files;
                        if (
                            pathComponentsOfCurrentEntity[i] != rootDirectory[i]
                        )
                            continue loop_over_files;
                    }
            ...
            this.removeRecursively = (pathComponents) => {
                this.recurse(pathComponents, (path) =>
                    this.remove(path, false),
                );
                this.initializeTree();
            };
            this.renameRecursively = (
                sourcePathComponents,
                destinationPathComponents,
            ) => {
    ...
    var filePaths = {
        ...
        chat: {
            ...
            reactions: (id) => [...filePaths.chat.chatBase(id), "reactions"],
            lastUsedPage: (id) => [
    ...
    var StorageViewModel = class extends Context {
        ...
        constructor(coreViewModel2) {
            ...
            this.getSelectedItemContent = () => {
                ...
                return (
                    (content ??
                        this.coreViewModel.translations.storage.notAFile) ||
            ...
            this.selectedFileName = createProxyState([this.selectedPath], () =>
    ...
    var SettingsViewModel = class _SettingsViewModel extends Context {
        ...
        constructor(coreViewModel2) {
            ...
            // methods
            this.setName = () => {
                this.coreViewModel.settingsModel.setName(
                    this.usernameInput.value,
                );
            ...
            this.firstDayOfWeek.value =
                coreViewModel2.settingsModel.firstDayOfWeek;
    ...
    var FileTransferViewModel = class extends Context {
        ...
        constructor(coreViewModel2) {
            ...
            this.filesSentText = createProxyState([this.filesSentCount], () =>
            ...
            this.prepareReceivingData = () => {
                ...
                this.coreViewModel.fileTransferModel.prepareToReceive(
                    transferData,
                );
            };
            // exit
        ...
        constructor(coreViewModel2) {
            ...
            this.connectionChangeHandler = () => {
                this.isConnected.value =
                    this.coreViewModel.connectionModel.isConnected;
                if (this.coreViewModel.connectionModel.isConnected == false)
                    return;
                if (this.coreViewModel.connectionModel.address == void 0)
                    return;
                this.serverAddressInput.value =
                    this.coreViewModel.connectionModel.address;
                if (
    ...
    var FileModel = class _FileModel {
        ...
        static {
            this.createFileContent = (fileId, type) => {
                ...
                const fileContentId =
                    _FileModel.generateFileContentId(creationDate);
                return {
    ...
    var BoardsAndTasksModel = class _BoardsAndTasksModel {
        ...
        constructor(storageModel2, settingsModel2, chatModel, fileModel) {
            ...
            this.createBoard = (name) => {
                const boardInfoFileContent =
                    _BoardsAndTasksModel.createBoardInfoFileContent(
                        v4_default(),
                        name,
                        "standard" /* Standard */,
                    );
            ...
            this.getBoardInfo = (fileId) => {
                const boardInfoFileContentOrNull =
            ...
            this.createTask = (boardId) => {
                const taskFileContent =
                    _BoardsAndTasksModel.createTaskFileContent(
                        v4_default(),
                        "",
                        boardId,
                    );
        ...
        static {
            this.createTaskFileContent = (fileId, name, boardId) => {
                const fileContent = FileModel.createFileContent(fileId, "task");
                return {
                    ...fileContent,
                    name,
                    boardId,
    ...
    var TaskViewModel = class extends Context {
        ...
        constructor(
            ...
            // paths
            this.getFilePath = () => {
                return this.boardsAndTasksModel.getTaskFilePath(
                    this.task.fileId,
                );
            };
            // state
            ...
            this.updateSuggestions = () => {
                if (
                    ...
                    this.coreViewModel.taskCategorySuggestions.add(
                        this.category.value,
                    );
                }
                if (
                    ...
                    this.coreViewModel.taskStatusSuggestions.add(
                        this.status.value,
                    );
                }
            };
    ...
    var TaskContainingPageViewModel = class extends Context {
        ...
        constructor(
            ...
            this.updateTaskIndices = () => {
                this.taskIndexManager.update([
                    ...this.taskViewModels.value.values(),
                ]);
    ...
    var BoardViewModel = class extends TaskContainingPageViewModel {
        ...
        constructor(
            ...
            this.index = new State(0);
            this.selectedPage = new State("list" /* List */);
            ...
            this.getBasePath = () => {
                return [
                    ...this.taskPageViewModel.getBoardViewPath(
            ...
            this.deleteBoard = () => {
                ...
                this.chatViewModel.taskBoardSuggestions.remove(
                    this.boardInfo.fileId,
                );
                this.close();
            };
            ...
            this.handleNewSearch = (searchTerm) => {
                ...
                if (
                    ...
                    this.coreViewModel.boardFilterStringSuggestions.add(
                        searchTerm,
                    );
                }
                const lastSearchPath = this.getLastSearchPath();
                this.coreViewModel.storageModel.write(
                    lastSearchPath,
                    searchTerm,
                );
            };
            ...
            this.loadTasks = () => {
                ...
                for (const taskId of taskIds) {
                    ...
                    const taskFileContent =
                        this.boardsAndTasksModel.getLatestTaskFileContent(
                            taskId,
                        );
            ...
            this.color.subscribe(() => {
                ...
                if (
                    this.chatViewModel.selectedPage.value != "tasks" /* Tasks */
                )
                    return;
                this.applyColor();
            });
    ...
    var TaskPageViewModel = class extends ContextHost {
        ...
        constructor(coreViewModel2, chatViewModel, boardsAndTasksModel) {
            ...
            this.selectedBoardId = new State(void 0);
            // guards
            ...
            this.createBoard = () => {
                ...
                const boardInfoFileContent =
                    this.boardsAndTasksModel.createBoard(
                        this.newBoardNameInput.value,
                    );
                this.newBoardNameInput.value = "";
                this.showBoardInList(boardInfoFileContent);
                this.boardsAndTasksModel.updateBoardAndSend(
            ...
            this.deleteBoard = (boardInfoFileContent) => {
                this.boardsAndTasksModel.deleteBoard(
                    boardInfoFileContent.fileId,
                );
            ...
            this.selectBoard = (boardViewModel) => {
                this.chatViewModel.displayedColor.value =
                    boardViewModel.color.value;
                if (
                    this.selectedBoardId.value ==
                    boardViewModel.boardInfo.fileId
                ) {
                    this.updateContexts();
                    return;
                }
            ...
            this.updateBoardIndices = () => {
                this.boardIndexManager.update([
                    ...this.boardViewModels.value.values(),
                ]);
    ...
    var SettingsPageViewModel = class extends Context {
        ...
        constructor(coreViewModel2, chatViewModel) {
            ...
            this.encryptionKeyInputType = createProxyState(
                ...
                () =>
                    this.shouldShowEncryptionKey.value == true
                        ? "text"
                        : "password",
            );
            this.color = new State("standard" /* Standard */);
            ...
            this.remove = () => {
                ...
                this.chatViewModel.chatListViewModel.untrackChat(
                    this.chatViewModel,
                );
            };
            // load
    ...
    var ChatModel = class _ChatModel {
        ...
        constructor(
            ...
            this.handleReaction = (reaction) => {
                ...
                if (reaction.isDeleting == true) {
                    ...
                    this.storageModel.writeStringifiable(
                        reactionPath,
                        reaction,
                    );
                }
        ...
        get messages() {
            const messageIds = this.storageModel.list(this.getMessageDirPath());
    ...
    var ChatMessageViewModel = class {
        ...
        constructor(
            ...
            this.reactionsDoubleAttentionCount =
                this.generateReactionCountProxyState(
                    "\u203C\uFE0F" /* DoubleAttention */,
                );
            ...
            this.cancelReply = () => {
                if (this.messagePageViewModel.replyingMessage.value != this)
                    return;
            ...
            this.handleReaction = (reaction) => {
                ...
                if (
                    reaction.sender != this.coreViewModel.settingsModel.username
                )
                    return;
    ...
    var MessagePageViewModel = class extends Context {
        ...
        constructor(coreViewModel2, chatViewModel) {
            ...
            this.replyingMessage = new State(void 0);
            ...
            this.showChatMessage = (chatMessage) => {
                ...
                const existingChatMessageViewModel =
                ...
                if (existingChatMessageViewModel != void 0) {
                    ...
                    existingChatMessageViewModel.status.value =
                        chatMessage.status;
                } else {
            ...
            this.handleReaction = (reaction) => {
                const messageViewModel = this.chatMessageViewModels.value.get(
                    reaction.messageId,
                );
            ...
            this.loadData = () => {
                ...
                for (const chatMessage of this.chatViewModel.chatModel
                    .messages) {
                    this.showChatMessage(chatMessage);
                }
    ...
    var CalendarPageViewModel = class extends TaskContainingPageViewModel {
        ...
        constructor(
            ...
            // methods
            this.createEvent = () => {
                const taskFileContent = this.boardsAndTasksModel.createTask(
    ...
    var ChatViewModel6 = class extends ContextHost {
        ...
        constructor(
            ...
            this.selectedPage = new State("messages" /* Messages */);
            ...
            this.resetColor = () => {
                this.displayedColor.value =
                    this.settingsPageViewModel.color.value;
            };
            this.updateIndex = () => {
                const index =
            ...
            this.loadInfo = () => {
                ...
                this.taskBoardSuggestions.set(CALENDAR_EVENT_BOARD_ID, [
                    CALENDAR_EVENT_BOARD_ID,
                    this.coreViewModel.translations.chatPage.calendar
                        .eventsBoard,
                ]);
            };
            this.updateReadStatus = () => {
                ...
                this.hasUnreadMessages.value =
                    this.chatModel.info.hasUnreadMessages;
            };
            this.setReadStatus = (hasUnreadMessages) => {
            ...
            this.registerKeyStroke("i", () =>
                this.openPage("tasks" /* Tasks */),
            );
            this.registerKeyStroke("o", () =>
                this.openPage("calendar" /* Calendar */),
            );
            this.registerKeyStroke("," /* Settings */, () =>
    ...
    var NotificationViewModel = class _NotificationViewModel {
        ...
        constructor(chatListViewModel2) {
            ...
            this.showNotification = (message) => {
                const notification =
                    _NotificationViewModel.createNotification(message);
                ...
                const currentPage =
                    this.chatListViewModel.selectedChat.value.selectedPage
                        .value;
                if (
            ...
            this.openNotification = () => {
                ...
                const chat = [
                    ...
                    (chat2) =>
                        chat2.chatModel.unwrappedPrimaryChannel ==
                        notification.chat,
                );
                chat.open();
    ...
    var ChatListViewModel = class {
        ...
        constructor(coreViewModel2, settingsViewModel2, connectionViewModel2) {
            ...
            this.selectedChat = new State(void 0);
            // guards
            ...
            this.untrackChat = (chatViewModel) => {
                this.coreViewModel.chatListModel.untrackChat(
            ...
            this.updateIndices = () => {
                this.chatIndexManager.update([
                    ...this.chatViewModels.value.values(),
                ]);
    ...
    function Option(text, value, selectedOnCreate) {
        return /* @__PURE__ */ createElement(
            "option",
            { value, "toggle:selected": selectedOnCreate },
            text,
        );
    }
    ...
    function HomePageButton(action, label, icon) {
        return /* @__PURE__ */ createElement(
            "button",
            { class: "tile flex-no", "on:click": action },
    ...
    function HomePage(
        ...
        const overviewSection = /* @__PURE__ */ createElement(
            "div",
            { id: "overview-section" },
            /* @__PURE__ */ createElement(
                "h2",
                null,
                coreViewModel2.translations.homePage.overviewHeadline,
            ),
            /* @__PURE__ */ createElement(
                "label",
                { class: "tile flex-no" },
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "span",
                        null,
                        coreViewModel2.translations.homePage.serverAddress,
                    ),
                    /* @__PURE__ */ createElement("input", {
                        list: "previous-connection-list",
                        placeholder:
                            coreViewModel2.translations.homePage
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    {
                        ...
                        "toggle:disabled":
                            connectionViewModel2.hasNoPreviousConnections,
                    },
                    /* @__PURE__ */ createElement(
                        "span",
                        { class: "icon" },
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "span",
                        null,
                        coreViewModel2.translations.homePage.yourNameLabel,
                    ),
                    /* @__PURE__ */ createElement("input", {
                        placeholder:
                            coreViewModel2.translations.homePage
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "button",
                        { class: "ghost width-50", "on:click": scrollToChat },
                        coreViewModel2.translations.homePage.scrollToChatButton,
                        /* @__PURE__ */ createElement(
                            "span",
                            { class: "icon" },
                            "arrow_forward",
        ...
        const chatSection = /* @__PURE__ */ createElement(
            "div",
            { id: "chat-section" },
            /* @__PURE__ */ createElement(
                "h2",
                null,
                coreViewModel2.translations.homePage.chatsHeadline,
            ),
            /* @__PURE__ */ createElement(
                "div",
                { class: "flex-row width-input" },
                /* @__PURE__ */ createElement("input", {
                    placeholder:
                        coreViewModel2.translations.homePage.addChatPlaceholder,
                    "aria-label":
                        coreViewModel2.translations.homePage.addChatAudioLabel,
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    {
                        class: "primary",
                        "aria-label":
                            coreViewModel2.translations.homePage.addChatButton,
    ...
    function ChatViewToggleButton(label, icon, page, chatViewModel) {
        ...
        if (page == "messages" /* Messages */) {
            chatViewModel.hasUnreadMessages.subscribe(
                (hasUnreadMessages) =>
                    (isHighlighted.value = hasUnreadMessages),
            );
        }
                ...
                /* @__PURE__ */ createElement(
                    ...
                    ...Object.entries(details).map((entry) =>
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "span",
                                { class: "icon", style: "font-size: 1.1rem" },
                                entry[0],
                            ),
                            /* @__PURE__ */ createElement(
                                "span",
    ...
    function collectPropertyValuesToState(
        propertyKey,
        stringEntryObjectConverter,
        objects,
        propertyValues,
    ...
    function StatusNameCell(coreViewModel2, statusName, index, boardViewModel) {
        ...
        const view = /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                "div",
                { class: "property-input-wrapper" },
                /* @__PURE__ */ createElement("input", {
                    placeholder:
                        coreViewModel2.translations.chatPage.task
    ...
    function CategoryRow(
        ...
        return FilteredList(
            ...
            (taskViewModels) => {
                ...
                const view = /* @__PURE__ */ createElement(
                    "div",
                    { class: "flex-row flex-no large-gap" },
                    /* @__PURE__ */ createElement(
                        "div",
                        { class: "property-input-wrapper" },
                        /* @__PURE__ */ createElement("input", {
    ...
    function StatusColumn(
        ...
        index,
        boardViewModel,
        taskViewModelsWithMatchingCategory,
    ) {
        ...
        taskViewModelsWithMatchingCategory.handleAddition((taskViewModel) => {
            ...
            taskViewModelsWithMatchingCategory.handleRemoval(
                taskViewModel,
                () => {
        ...
        const view = /* @__PURE__ */ createElement("div", {
    ...
    function DangerousActionButton(coreViewModel2, label, icon, action) {
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                ...
                coreViewModel2.translations.general.abortButton,
                /* @__PURE__ */ createElement(
                    "span",
                    { class: "icon" },
                    "undo",
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "span",
                                null,
                                coreViewModel2.translations.general
                                    .fileVersionLabel,
                            ),
    ...
    function SearchModal(
        ...
        return /* @__PURE__ */ createElement(
            "div",
            { class: "modal", "toggle:open": isOpen, extended: true },
            /* @__PURE__ */ createElement(
                "div",
                null,
                /* @__PURE__ */ createElement(
                    "main",
                    null,
                    /* @__PURE__ */ createElement("h2", null, headline),
                    /* @__PURE__ */ createElement(
                        "div",
                        { class: "flex-row width-input" },
                        /* @__PURE__ */ createElement("input", {
                            id: "focused",
                            placeholder:
                                coreViewModel2.translations.general.searchLabel,
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            {
                                ...
                                "toggle:disabled":
                                    searchViewModel.cannotApplySearch,
                            },
                            /* @__PURE__ */ createElement(
                                "span",
                                { class: "icon" },
    ...
    function BoardPage(coreViewModel2, boardViewModel) {
        ...
        return /* @__PURE__ */ createElement(
                        ...
                        "button",
                        {
                            ...
                            "aria-label":
                                coreViewModel2.translations.chatPage.task
                                    .toggleBoardButtonAudioLabel,
                            "on:click":
                                boardViewModel.taskPageViewModel
                                    .toggleBoardList,
                            "toggle:selected":
                                boardViewModel.taskPageViewModel
                                    .isShowingBoadList,
            ...
            BoardSettingsModal(coreViewModel2, boardViewModel),
            SearchModal(
                coreViewModel2,
            ...
            /* @__PURE__ */ createElement("div", {
                "children:set": taskSettingsModal,
            }),
        );
    }
    ...
    function PlaceholderView(text) {
        return /* @__PURE__ */ createElement(
            "div",
            {
                class: "width-100 height-100 flex-column justify-center align-center",
            },
            /* @__PURE__ */ createElement(
                "span",
                { class: "secondary slide-up" },
                text,
            ),
        );
    }
    ...
    function TaskPage(coreViewModel2, taskPageViewModel) {
        ...
        const pages = ViewController.taskPages.setState(persistenceId, () =>
            createProxyState([taskPageViewModel.selectedBoardId], () => {
                ...
                const selectedBoard =
                    taskPageViewModel.boardViewModels.value.get(
                        selectedBoardId,
                    );
                if (selectedBoard == void 0) {
                    return /* @__PURE__ */ createElement(
                        "div",
                        { class: "pane align-center justify-center" },
                        /* @__PURE__ */ createElement(
                            "span",
                            { class: "secondary" },
                            coreViewModel2.translations.chatPage.task
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement("input", {
                                class: "no-outline",
                                "bind:value":
                                    taskPageViewModel.newBoardNameInput,
                            ...
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    class: "primary",
                                    "aria-label":
                                        coreViewModel2.translations.chatPage
                                            .task.createBoardButtonAudioLabel,
    ...
    function DeletableListItem(coreViewModel2, text, primaryButton, ondelete) {
        return /* @__PURE__ */ createElement(
            "div",
            { class: "tile flex-row justify-apart align-center padding-0" },
            /* @__PURE__ */ createElement(
                "span",
                { class: "padding-h ellipsis" },
                text,
            ),
            /* @__PURE__ */ createElement(
                "div",
    ...
    function SettingsPage(coreViewModel2, settingsPageViewModel) {
        ...
        const secondaryChannelConverter = (secondaryChannel) => {
            return DeletableListItem(
                ...
                () => {
                    settingsPageViewModel.removeSecondaryChannel(
                        secondaryChannel,
                    );
                },
            );
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "span",
                            { class: "title" },
                            coreViewModel2.translations.chatPage.settings
                                .settingsHeadline,
                        ),
                    ),
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "div",
                            { class: "flex-row justify-end width-input" },
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    class: "width-50",
                        ...
                        /* @__PURE__ */ createElement(
                            "div",
                            { class: "flex-row width-input margin-bottom" },
                            /* @__PURE__ */ createElement("input", {
                                "aria-label":
                                    coreViewModel2.translations.chatPage
                                        .settings.newSecondaryChannelAudioLabel,
                                placeholder:
                                    coreViewModel2.translations.chatPage
                                        .settings
                                        .newSecondaryChannelPlaceholder,
    ...
    function MessageFilterModal(
        ...
        return /* @__PURE__ */ createElement(
            ...
            {
                class: "modal",
                "toggle:open": messagePageViewModel.isFilterModalOpen,
            },
            /* @__PURE__ */ createElement(
                "div",
                null,
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "h2",
                        null,
                        coreViewModel2.translations.chatPage.message
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            {
                                ...
                                "on:click":
                                    messagePageViewModel.revokeReactionFilter,
                            },
                            coreViewModel2.translations.chatPage.message
                        ...
                        /* @__PURE__ */ createElement(
                            "div",
                            { class: "grid gap message-reaction-filter" },
    ...
    function MessageReactionButton(
        ...
        switch (content) {
            ...
            case "\u2705" /* Check */: {
                audioLabel =
                    coreViewModel2.translations.chatPage.message.checkReaction;
                count = chatMessageViewModel.reactionsCheckCount;
                break;
            }
            case "\u{1F6D1}" /* Stop */: {
                audioLabel =
                    coreViewModel2.translations.chatPage.message.stopReaction;
    ...
    function MessageReactionButtonRow(coreViewModel2, chatMessageViewModel) {
        return /* @__PURE__ */ createElement(
            "div",
            { class: "grid gap width-100 message-reaction-row" },
    ...
    function InlineReply(chatMessageViewModel) {
        ...
        return /* @__PURE__ */ createElement(
            "div",
            { class: "inline-reply", "on:click": scroll },
            /* @__PURE__ */ createElement("span", null, reply.sender),
            /* @__PURE__ */ createElement("b", {
                class: "ellipsis",
                "subscribe:innerText": reply.body,
            }),
        );
    }
    ...
    function MessageReactionEntry(reaction) {
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement("span", null, reaction.content),
        );
    }
    ...
    function InfoTile(icon, label, content) {
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement("b", {
                    class: "break-word",
                    "subscribe:innerText": contentState,
                }),
            ),
        );
    }
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            { "on:click": chatMessageViewModel.copyMessage },
                            coreViewModel2.translations.chatPage.message
                                .copyMessageButton,
                            /* @__PURE__ */ createElement(
                                "span",
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            { "on:click": chatMessageViewModel.resendMessage },
                            coreViewModel2.translations.chatPage.message
                                .resendMessageButton,
                            /* @__PURE__ */ createElement(
                                "span",
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            { "on:click": chatMessageViewModel.decryptMessage },
                            coreViewModel2.translations.chatPage.message
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    { "on:click": chatMessageViewModel.hideInfoModal },
                    coreViewModel2.translations.general.closeButton,
                    /* @__PURE__ */ createElement(
                        "span",
                        { class: "icon" },
    ...
    function MessagePage(coreViewModel2, messagePageViewModel) {
        ...
        const messageContainer = /* @__PURE__ */ createElement("div", {
        ...
        const replyPreview = ViewController.inlineReplies.setState(
            persistenceId,
            () =>
                createProxyState([messagePageViewModel.replyingMessage], () => {
                ...
                /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    class: "ghost inset-outline",
                                    "on:click":
                                        messagePageViewModel.showFilterModal,
                                    "aria-label":
                                        coreViewModel2.translations.chatPage
                                            .message
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "div",
                                { class: "content-width-constraint" },
                                /* @__PURE__ */ createElement("div", {
        ...
        while (dayLabels.length < 7) {
            dayLabels.push(
                /* @__PURE__ */ createElement(
                    "span",
                    { class: "secondary" },
                    coreViewModel2.translations.regional.weekdays.abbreviated[
                        currentWeekday
                    ],
                ),
            );
                    ...
                    .map((entry) => {
                        ...
                        const isToday = createProxyState(
                            ...
                            () => {
                                return (
                                    ...
                                    date ==
                                        coreViewModel2.unwrappedTodayDate
                                            .getDate()
                                            .toString()
                                            .padStart(2, "0")
                                );
                        ...
                        return /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "div",
                                null,
                                /* @__PURE__ */ createElement("b", null, date),
                                /* @__PURE__ */ createElement("span", {
                                    class: "event-count",
    ...
    function CalendarPage(coreViewModel2, calendarPageViewModel) {
        ...
        const taskSettingsModal = createProxyState(
            ...
            () => {
                if (
                    calendarPageViewModel.selectedTaskViewModel.value == void 0
                ) {
                    return /* @__PURE__ */ createElement("div", null);
                } else {
                    ViewController.setFocusWithDelay();
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                "div",
                { class: "pane-wrapper grid-pane-wrapper" },
                /* @__PURE__ */ createElement(
                    "div",
                    { class: "pane" },
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    ...
                                    "aria-label":
                                        coreViewModel2.translations.chatPage
                                            .calendar.todayButtonAudioLabel,
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    ...
                                    "aria-label":
                                        coreViewModel2.translations.chatPage
                                            .calendar.nextMonthButtonAudioLabel,
                                    "on:click":
                                        calendarPageViewModel.showNextMonth,
                                },
                                /* @__PURE__ */ createElement(
                                    "span",
                                    { class: "icon" },
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "button",
                                {
                                    ...
                                    "aria-label":
                                        coreViewModel2.translations.chatPage
                                            .task.createTaskButtonAudioLabel,
                                    "on:click":
                                        calendarPageViewModel.createEvent,
                                },
                                /* @__PURE__ */ createElement(
                                    "span",
                                    { class: "icon" },
            ...
            /* @__PURE__ */ createElement(
                "div",
                {
                    class: "pane-wrapper side background",
                    "set:color":
                        calendarPageViewModel.chatViewModel.displayedColor,
                },
                /* @__PURE__ */ createElement(
                    "div",
                    { class: "pane" },
        ...
        const marqueeContent = createProxyState(
            ...
            () => {
                ...
                return /* @__PURE__ */ createElement(
                    ...
                    {
                        "on:click":
                            chatViewModel.notificationViewModel
                                .openNotification,
                    },
    ...
    function SplitModal(
        ...
        const view = /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement("div", {
                    class: "scroll-area",
                    "children:set": leftView,
                }),
            ),
            /* @__PURE__ */ createElement(
                "div",
                { class: "scroll-area slide-up" },
                /* @__PURE__ */ createElement(
                    "div",
                    {
    ...
    function DirectoryItemList(
        storageViewModel2,
        pathString = PATH_COMPONENT_SEPARATOR,
    ) {
        const StringToDirectoryItemList = (pathString2) =>
            DirectoryItemList(storageViewModel2, pathString2);
        ...
        function loadItems() {
            ...
            const directoryItems =
                storageViewModel2.coreViewModel.storageModel.list(path);
            for (const directoryItem of directoryItems) {
                const itemPath = [...path, directoryItem];
                const pathString2 = StorageModel.pathComponentsToString(
                    ...itemPath,
                );
        ...
        storageViewModel2.lastDeletedItemPath.subscribe(
            (lastDeletedItemPath) => {
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    "span",
                    { class: "ellipsis width-100 flex-1", style },
                    fileName,
                ),
            ),
            /* @__PURE__ */ createElement("div", {
    ...
    function StorageModal(coreViewModel2, storageViewModel2) {
        const detailView = createProxyState(
            ...
            () => {
                if (
                    storageViewModel2.selectedPath.value ==
                    ...
                    return /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "span",
                            { class: "secondary" },
                            coreViewModel2.translations.storage.noItemSelected,
                        ),
                        /* @__PURE__ */ createElement("hr", null),
                        DangerousActionButton(
                            coreViewModel2,
                            coreViewModel2.translations.storage
                                .removeJunkButton,
                            "delete_forever",
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "b",
                                null,
                                coreViewModel2.translations.storage.path,
                            ),
                            /* @__PURE__ */ createElement("span", {
                                class: "break-all",
                                "subscribe:innerText":
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                "b",
                                null,
                                coreViewModel2.translations.storage.content,
                            ),
                            /* @__PURE__ */ createElement("code", {
                                "subscribe:innerText":
                                    storageViewModel2.selectedFileContent,
                            }),
                        ),
                    ),
                    DangerousActionButton(
        ...
        return /* @__PURE__ */ createElement(
            ...
            {
                class: "modal",
                "toggle:open": storageViewModel2.isShowingStorageModal,
            },
            /* @__PURE__ */ createElement(
                "div",
                null,
    ...
    function NavigationButton(
        ...
        return /* @__PURE__ */ createElement(
            "button",
            { "toggle:selected": isSelected, "on:click": open },
            label,
            /* @__PURE__ */ createElement(
                "span",
                { class: iconClass },
    ...
    function SettingsInfoPane(coreViewModel2, settingsViewModel2) {
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                "h2",
                null,
                coreViewModel2.translations.homePage.appName,
            ),
            /* @__PURE__ */ createElement("hr", null),
            /* @__PURE__ */ createElement(
                "div",
    ...
    function SettingsRegionalPane(coreViewModel2, settingsViewModel2) {
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                "h3",
                null,
                coreViewModel2.translations.settings.language,
            ),
            OptionButtonList(
                new ListState(
            ...
            /* @__PURE__ */ createElement(
                "h3",
                null,
                coreViewModel2.translations.settings.firstDayOfWeekLabel,
            ),
            OptionButtonList(
                new ListState(
    ...
    function DataTransferModalWrapper(
        coreViewModel2,
        connectionViewModel2,
        fileTransferViewModel2,
    ) {
        return /* @__PURE__ */ createElement(
            ...
            FileSelectionModal(coreViewModel2, fileTransferViewModel2),
            TransferDataDisplayModal(coreViewModel2, fileTransferViewModel2),
            TransferDisplayModal(coreViewModel2, fileTransferViewModel2),
            TransferDataInputModal(coreViewModel2, fileTransferViewModel2),
            DataReceptionModal(coreViewModel2, fileTransferViewModel2),
        );
    }
    function DirectionSelectionModal(
        ...
        const isPresented = createProxyState(
            ...
            () =>
                fileTransferViewModel2.presentedModal.value ==
                0 /* DirectionSelection */,
        );
        ...
        return /* @__PURE__ */ createElement(
            "div",
            { class: "modal", "toggle:open": isPresented },
            /* @__PURE__ */ createElement(
                "div",
                null,
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "h2",
                        null,
                        coreViewModel2.translations.dataTransferModal
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            {
                                class: "tile",
                                "on:click":
                                    fileTransferViewModel2.showFileSelectionModal,
                            },
                            /* @__PURE__ */ createElement(
                                "span",
                                { class: "icon" },
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement(
                                    ...
                                    null,
                                    coreViewModel2.translations
                                        .dataTransferModal.fromThisDeviceButton,
                                ),
                            ),
                            /* @__PURE__ */ createElement(
                                "span",
                        ...
                        /* @__PURE__ */ createElement(
                            "button",
                            {
                                class: "tile",
                                "on:click":
                                    fileTransferViewModel2.showTransferDataInputModal,
                            },
                            /* @__PURE__ */ createElement(
                                "span",
                                { class: "icon" },
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement(
                                    ...
                                    null,
                                    coreViewModel2.translations
                                        .dataTransferModal.toThisDeviceButton,
                                ),
                            ),
                            /* @__PURE__ */ createElement(
                                "span",
    ...
    function FileSelectionModal(coreViewModel2, fileTransferViewModel2) {
        ...
        function OptionEntry(fileOption, fileTransferViewModel3) {
            ...
            if (
                fileTransferViewModel3.selectedPaths.value.has(fileOption.path)
            ) {
            ...
            isSelected.subscribeSilent((isSelected2) => {
                if (isSelected2 == true) {
                    ...
                    fileTransferViewModel3.selectedPaths.remove(
                        fileOption.path,
                    );
                }
            });
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "button",
                        {
                            class: "primary flex",
                            "on:click":
                                fileTransferViewModel2.showTransferDataModal,
                            "toggle:disabled":
                                fileTransferViewModel2.hasNoPathsSelected,
                        },
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement("b", {
                                    "subscribe:innerText":
                                        fileTransferViewModel2.transferChannel,
                                }),
                            ),
                        ),
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement(
                                    ...
                                    { class: "secondary" },
                                    coreViewModel2.translations
                                        .dataTransferModal.transferKeyHeadline,
                                ),
                                /* @__PURE__ */ createElement("b", {
                                    "subscribe:innerText":
                                        fileTransferViewModel2.transferKey,
                                }),
                            ),
                        ),
                    ),
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement(
                        "button",
                        { disabled: true, class: "flex" },
                        coreViewModel2.translations.general.waitingLabel,
                    ),
                ),
            ),
        );
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement("p", {
                        class: "secondary",
                        "subscribe:innerText":
                            fileTransferViewModel2.filesSentText,
                    }),
                    /* @__PURE__ */ createElement(
                        "p",
                        {
                            class: "secondary",
                            "toggle:hidden":
                                fileTransferViewModel2.didNotFinishSending,
                        },
                        coreViewModel2.translations.dataTransferModal
                            .allFilesSent,
                    ),
                    ...
                    /* @__PURE__ */ createElement(
                        ...
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement("input", {
                                    "on:enter":
                                        fileTransferViewModel2.prepareReceivingData,
                                    "bind:value":
                                        fileTransferViewModel2.receivingTransferChannel,
                                }),
                            ),
                        ),
                        /* @__PURE__ */ createElement(
                            ...
                            /* @__PURE__ */ createElement(
                                ...
                                /* @__PURE__ */ createElement("input", {
                                    "on:enter":
                                        fileTransferViewModel2.prepareReceivingData,
                                    "bind:value":
                                        fileTransferViewModel2.receivingTransferKey,
                                }),
                            ),
                        ),
                    ),
                    ...
                    /* @__PURE__ */ createElement(
                        "button",
                        {
                            ...
                            "on:click":
                                fileTransferViewModel2.prepareReceivingData,
                            "toggle:disabled":
                                fileTransferViewModel2.cannotPrepareToReceive,
                        },
                        coreViewModel2.translations.general.continueButton,
                        /* @__PURE__ */ createElement(
                            "span",
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    ...
                    /* @__PURE__ */ createElement("p", {
                        class: "secondary",
                        "subscribe:innerText":
                            fileTransferViewModel2.filesReceivedText,
                    }),
                    /* @__PURE__ */ createElement("hr", null),
                    /* @__PURE__ */ createElement("div", {
                        class: "tile flex-column align-start",
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    { "on:click": ViewController.reload },
                    coreViewModel2.translations.general.reloadAppButton,
                    /* @__PURE__ */ createElement(
                        "span",
                        { class: "icon" },
                        "refresh",
    ...
    function ConnectionModal(coreViewModel2, connectionViewModel2) {
        const previousAddressConverter = (address) => {
            ...
            const cannotConnect = createProxyState(
                [connectionViewModel2.isConnected],
                () =>
                    connectionViewModel2.isConnected.value == true &&
                    connectionViewModel2.coreViewModel.connectionModel
                        .address == address,
            );
            return DeletableListItem(
                coreViewModel2,
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    {
                        ...
                        "aria-label":
                            coreViewModel2.translations.connectionModal
        ...
        return /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement(
                ...
                /* @__PURE__ */ createElement(
                    "button",
                    { "on:click": connectionViewModel2.hideConnectionModal },
                    coreViewModel2.translations.general.closeButton,
                    /* @__PURE__ */ createElement(
                        "span",
                        { class: "icon" },
                ...
                const addObjects = (potentialObjects2) => {
                    ...
                    for (const potentialObjectEntry of potentialObjects2) {
                        ...
                        for (const potentialVersion of contentVersions) {
                            const isV1MessageObjectContent =
    ...
    var FileTransferModel = class _FileTransferModel {
        ...
        constructor(storageModel2, connectionModel2) {
            ...
            this.handleMessage = (data) => {
                ...
                if (
                    data.messageBody == _FileTransferModel.READY_MESSAGE &&
                    this.direction == 0 /* Send */
                ) {
            ...
            try {
                ...
                this.ws.addEventListener("message", (message) => {
                    ...
                    if (data.assignedMailboxId) {
                        ...
                        this.send({
                            uuid: data.uuid,
                            confirmingMessageReceived: true,
                        });
    ...
    var ChatListModel = class {
        ...
        constructor(storageModel2, settingsModel2, connectionModel2) {
            ...
            this.messageHandler = (data) => {
                ...
                this.routeMessageToCorrectChatModel(channel, (chatModel) =>
            ...
            this.routeMessageToCorrectChatModel = (channel, fn) => {
                ...
                for (const chatModel of this.chatModels) {
                    for (const channel2 of allChannels) {
                        if (channel2 != chatModel.unwrappedPrimaryChannel)
                            continue;
                        fn(chatModel);
                        break;
                    }
    ...
    document.body.append(
        /* @__PURE__ */ createElement(
            ...
            /* @__PURE__ */ createElement("div", { id: "sky" }),
            /* @__PURE__ */ createElement("div", { id: "grass-1" }),
            /* @__PURE__ */ createElement("div", { id: "grass-2" }),
        ),
    );
    document
        .querySelector("main")
